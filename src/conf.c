...
parse_auth_server(FILE *file, const char *filename, int *linenum)
{
	...
	apiscriptpathfragment  = safe_strdup(DEFAULT_AUTHSERVAPIPATHFRAGMENT);
	...
	new->authserv_api_script_path_fragment  = apiscriptpathfragment;
